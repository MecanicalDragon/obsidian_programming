**TCP** – Transmission Control Protocol, протокол управления передачей - транспортный протокол передачи данных в сетях TCP/IP, предварительно устанавливающий соединение с сетью. ^TCP
