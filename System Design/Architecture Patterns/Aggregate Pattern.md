...
4. **[[System Design/Architecture Patterns/Event Sourcing]] / [[System Design/Architecture Patterns/CQRS]]** — агрегаты естественно вписываются как единицы, которые производят *domain events* (например, `AccountCredited`, `MoneyWithdrawn`).
