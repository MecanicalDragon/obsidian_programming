...
- **Представление** — отображение данных Модели, обращается к Presenter за обновлениями, перенаправляет события от пользователя в Presenter. Вид - это та часть UI, которая отображает данные пользователю.
