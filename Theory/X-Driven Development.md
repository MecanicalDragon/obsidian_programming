...
Разработка на основе типов — это еще один правильный метод построения приложения, который может повысить уверенность в коде и сэкономить время при внесении изменений в большую кодовую базу.
[[Типизация]]
